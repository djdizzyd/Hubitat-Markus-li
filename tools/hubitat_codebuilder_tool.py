...
def main():
    ...
    cb = HubitatCodeBuilder()
    driver_dir = Path("./drivers")
    apps_dir = Path("./apps")
    expanded_drivers_dir = driver_dir / 'expanded'
    expanded_apps_dir = apps_dir / 'expanded'
    ...
    driver_files = [
        ...
        {'id': 418, 'file': driver_dir / 'tasmota-tuyamcu-wifi-touch-switch-child.groovy', \
        ...
        {'id': 556, 'file': driver_dir / 'tasmota-sonoff-basic.groovy', \
        ...
        {'id': 580, 'file': driver_dir / 'tasmota-tuyamcu-wifi-dimmer.groovy' , \
        ...
        {'id': 581, 'file': driver_dir / 'tasmota-generic-wifi-switch-plug.groovy' , \
        ...
        {'id': 582, 'file': driver_dir / 'tasmota-generic-wifi-switch-plug.groovy' , \
        ...
        {'id': 583, 'file': driver_dir / 'tasmota-generic-wifi-switch-plug.groovy' , \
        ...
        {'id': 584, 'file': driver_dir / 'tasmota-generic-wifi-switch-plug.groovy' , \
        ...
        {'id': 585, 'file': driver_dir / 'tasmota-generic-wifi-switch-plug.groovy' , \
        ...
        {'id': 586, 'file': driver_dir / 'tasmota-generic-pm-plug.groovy' , \
        ...
        {'id': 587, 'file': driver_dir / 'tasmota-generic-pm-plug.groovy' , \
        ...
        {'id': 589, 'file': driver_dir / 'tasmota-generic-rgb-rgbw-controller-bulb-dimmer.groovy',
        ...
        {'id': 548, 'file': driver_dir / 'tasmota-tuyamcu-wifi-touch-switch.groovy' },
        {'id': 549, 'file': driver_dir / 'tasmota-tuyamcu-wifi-touch-switch-child.groovy' },
        {'id': 550, 'file': driver_dir / 'tasmota-tuyamcu-wifi-touch-switch-child-test.groovy' },
        {'id': 513, 'file': driver_dir / 'tasmota-sonoff-powr2.groovy' },
        {'id': 551, 'file': driver_dir / 'tasmota-sonoff-s2x.groovy' },
        {'id': 554, 'file': driver_dir / 'tasmota-sonoff-mini.groovy'},
        {'id': 560, 'file': driver_dir / 'tasmota-sonoff-basic.groovy'},
        {'id': 552, 'file': driver_dir / 'tasmota-generic-wifi-switch-plug.groovy' },
        {'id': 553, 'file': driver_dir / 'tasmota-s120-plug.groovy' },
        {'id': 557, 'file': driver_dir / 'tasmota-ykyc-001-pm-plug.groovy' },
        {'id': 559, 'file': driver_dir / 'tasmota-brilliant-bl20925-pm-plug.groovy' },
        {'id': 577, 'file': driver_dir / 'tasmota-prime-ccrcwfii113pk-plug.groovy' },
        {'id': 558, 'file': driver_dir / 'tasmota-generic-pm-plug.groovy' },
        {'id': 578, 'file': driver_dir / 'tasmota-generic-thp-device.groovy' },
        {'id': 590, 'file': driver_dir / 'tasmota-tuyamcu-wifi-dimmer.groovy'},
        {'id': 588, 'file': driver_dir / 'tasmota-unbranded-rgb-controller-with-ir.groovy' },
        {'id': 591, 'file': driver_dir / 'tasmota-generic-rgb-rgbw-controller-bulb-dimmer.groovy' },

        # Zigbee
        {'id': 579, 'file': driver_dir / 'zigbee-generic-wifi-switch-plug.groovy' },
    ...
    for d in driver_files:
        ...
        if('alternate_output_filename' in d and d['alternate_output_filename'] != ''):
            ...
            expanded_result = cb.expandGroovyFile(d['file'], expanded_drivers_dir, alternate_output_filename=d['alternate_output_filename'], \
            ...
            expanded_result = cb.expandGroovyFile(d['file'], expanded_drivers_dir)
        print(expanded_result)
        if(d['id'] != 0):
            j += 1
            r = hhs.push_driver_code(d['id'], cb.getOutputGroovyFile(d['file'], expanded_drivers_dir, alternate_output_filename=aof))
            try:
                if 'source' in r:
                    r['source'] = '<hidden>'
                #print(r)
                ...
                used_drivers_dict[id] = drivers_dict[id]
    ...
    if(len(used_drivers_dict) >= expected_num_drivers):
    ...
    #pp.pprint(used_drivers_dict)
    
    apps_files = [
        {'id': 97, 'file': apps_dir / 'tasmota-connect.groovy' },
        {'id': 163, 'file': apps_dir / 'tasmota-connect-test.groovy' },
    ]

    for a in apps_files:
        if(a['id'] != 97 or a['id'] != 163):
            cb.expandGroovyFile(a['file'], expanded_apps_dir, used_drivers_dict)
        if(a['id'] != 0 and len(used_drivers_dict) >= expected_num_drivers):
            cb.expandGroovyFile(a['file'], expanded_apps_dir, used_drivers_dict)
            print('Found ' + str(len(used_drivers_dict)) + ' driver(s)...')
            r = hhs.push_app_code(a['id'], cb.getOutputGroovyFile(a['file'], expanded_apps_dir))
            try:
                id = r['id']
            except Exception:
                id = 0
            ...
            if(a['id'] == 0):
                ...
                print("Not ready for App updates! Only " + str(len(used_drivers_dict)) + " driver(s) currently active! Skipped updating App ID " + str(a['id']))
    
    #cb.expandGroovyFile(driver_dir / 'tasmota-sonoff-powr2.groovy', expanded_dir)
    #hhs.push_driver_code(513, cb.getOutputGroovyFile(driver_dir / 'tasmota-sonoff-powr2.groovy', expanded_dir))
