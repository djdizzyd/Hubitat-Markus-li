...
metadata {
	definition (name: "Tasmota - Generic Wifi Switch/Plug", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-generic-wifi-switch-plug-expanded.groovy") {
        capability "Actuator"
        capability "Outlet"
		capability "Switch"
...
public getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - Generic Wifi Switch/Plug', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-generic-wifi-switch-plug-expanded.groovy']
