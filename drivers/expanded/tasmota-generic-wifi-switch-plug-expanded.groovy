...
metadata {
	definition (name: "Tasmota - Generic Wifi Switch/Plug", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/master/drivers/expanded/tasmota-generic-wifi-switch-plug-expanded.groovy") {
        capability "Actuator"
		capability "Switch"
		capability "Sensor"
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - Generic Wifi Switch/Plug', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/master/drivers/expanded/tasmota-generic-wifi-switch-plug-expanded.groovy']
