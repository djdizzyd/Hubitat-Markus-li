...
metadata {
	definition (name: "Tasmota - Sonoff 4CH (Parent)", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-sonoff-4ch-parent-expanded.groovy") {
        capability "Actuator"
        capability "Light"
		capability "Switch"
		capability "Sensor"
...
public getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - Sonoff 4CH (Parent)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-sonoff-4ch-parent-expanded.groovy']
...
private def getDriverVersion() {
    comment = "UNTESTED driver - <a target=\"blakadder\" href=\"https://templates.blakadder.com/sonoff_4CH.html\">Device Model Info</a>"
