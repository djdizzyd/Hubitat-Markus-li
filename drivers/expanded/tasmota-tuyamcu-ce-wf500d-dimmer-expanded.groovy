...
metadata {
	definition (name: "Tasmota - TuyaMCU CE Smart Home WF500D Dimmer (EXPERIMENTAL)", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-tuyamcu-ce-wf500d-dimmer-expanded.groovy") {
        capability "Light"
        capability "Switch"
...
public getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - TuyaMCU CE Smart Home WF500D Dimmer (EXPERIMENTAL)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-tuyamcu-ce-wf500d-dimmer-expanded.groovy']
...
private def getDriverVersion() {
    comment = "WORKING, but need feedback from users - <a target=\"blakadder\" href=\"https://templates.blakadder.com/ce_smart_home-WF500D.html\">Device Model Info</a>"
