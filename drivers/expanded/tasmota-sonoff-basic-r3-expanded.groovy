...
metadata {
	definition (name: "Tasmota - Sonoff Basic R3", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-sonoff-basic-r3-expanded.groovy") {
        capability "Actuator"
        capability "Light"
		capability "Switch"
		capability "Sensor"
...
public getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - Sonoff Basic R3', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-sonoff-basic-r3-expanded.groovy']
...
private def getDriverVersion() {
    comment = "<a target=\"blakadder\" href=\"https://templates.blakadder.com/sonoff_basic_R3.html\">Device Model Info</a>"
