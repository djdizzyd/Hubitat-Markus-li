...
metadata {
    definition (name: "Tasmota - KMC 4 Power Monitor Plug (Child)", namespace: "tasmota", author: "Markus Liljergren") {
        capability "Switch"
        capability "Actuator"
    }
}
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - KMC 4 Power Monitor Plug (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren']
