...
metadata {
	definition (name: "Tasmota - AWP04L Power Monitor Plug", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch") {
        capability "Actuator"
		capability "Switch"
		capability "Sensor"
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - AWP04L Power Monitor Plug', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch']
...
private def getDriverVersion() {
	...
	def cmds = []
    comment = "<a target=\"blakadder\" href=\"https://templates.blakadder.com/awp04l.html\">Device Info</a>"
