...
metadata {
    ...
    preferences {
        ...
        input(name: "numSwitches", type: "enum", title: "<b>Number of Relays</b>", description: "<i>Set the number of buttons/relays on the device (default 3)</i>", options: ["1", "2", "3", "4", "5", "6"], defaultValue: "3", displayDuringSetup: true, required: true)
