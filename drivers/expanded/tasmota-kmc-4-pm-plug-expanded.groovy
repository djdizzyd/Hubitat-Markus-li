...
metadata {
	definition (name: "Tasmota - KMC 4 Power Monitor Plug", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch") {
        capability "Actuator"
		capability "Switch"
		capability "Sensor"
    ...
    preferences {
        ...
        input(name: "numSwitches", type: "enum", title: "<b>Number of Relays</b>", description: "<i>Set the number of buttons/relays on the device (default 3)</i>", options: ["1", "2", "3", "4"], defaultValue: "3", displayDuringSetup: true, required: true)
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - KMC 4 Power Monitor Plug', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch']
...
def update_needed_settings()
{
    ...
    if(deviceTemplateInput == null || deviceTemplateInput == "") {
        ...
        useDefaultTemplate = true
        defaultDeviceTemplate = '{"NAME":"KMC 4 Plug","GPIO":[0,56,0,0,133,132,0,0,130,22,23,21,17],"FLAG":0,"BASE":36}'
    }
...
private def getDriverVersion() {
	...
	def cmds = []
    comment = "<a target=\"blakadder\" href=\"https://templates.blakadder.com/kmc-4.html\">Device Model Info</a>"
