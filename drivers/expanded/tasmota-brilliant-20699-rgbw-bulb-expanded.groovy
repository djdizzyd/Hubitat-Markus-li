...
metadata {
	definition (name: "Tasmota - Brilliant 20699 800lm RGBW (EXPERIMENTAL)", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch") {
        capability "Actuator"
		capability "Switch"
		capability "Sensor"
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - Brilliant 20699 800lm RGBW (EXPERIMENTAL)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch']
