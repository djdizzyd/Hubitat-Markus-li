...
metadata {
	definition (name: "Tasmota - Brilliant 20699 800lm RGBW Bulb", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-brilliant-20699-rgbw-bulb-expanded.groovy") {
        capability "Actuator"
        capability "Light"
        capability "Switch"
...
def update_needed_settings() {
    ...
    if(deviceTemplateInput == null || deviceTemplateInput == "") {
        ...
        useDefaultTemplate = true
        defaultDeviceTemplate = '{"NAME":"Brilliant20699","GPIO":[0,0,0,0,141,140,0,0,37,142,0,0,0],"FLAG":0,"BASE":18}'
    }
...
private def getDriverVersion() {
    comment = "<a target=\"blakadder\" href=\"https://templates.blakadder.com/brilliant_20699.html\">Device Model Info</a>"
