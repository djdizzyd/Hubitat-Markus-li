...
metadata {
	definition (name: "Tasmota - AWP02L-N Plug", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch") {
        capability "Actuator"
		capability "Switch"
		capability "Sensor"
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - AWP02L-N Plug', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch']
...
private def getDriverVersion() {
	...
	def cmds = []
    comment = "<a target=\"blakadder\" href=\"https://templates.blakadder.com/hugoai_awp02l-n.html\">Device Info</a>"
