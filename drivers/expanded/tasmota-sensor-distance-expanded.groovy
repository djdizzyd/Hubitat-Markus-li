...
metadata {
	definition (name: "Tasmota - Sensor (Distance)", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-sensor-distance-expanded.groovy") {
...
public getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - Sensor (Distance)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-sensor-distance-expanded.groovy']
...
def update_needed_settings()
{
    ...
    if(deviceTemplateInput == null || deviceTemplateInput == "") {
        ...
        useDefaultTemplate = true
        defaultDeviceTemplate = '{"NAME":"Generic","GPIO":[0,0,0,0,0,0,0,0,74,73,0,0,0],"FLAG":0,"BASE":18}'
    }
...
private def getDriverVersion() {
    comment = "UNTESTED driver - <a target=\"blakadder\" href=\"https://github.com/arendst/Tasmota/wiki/HC-SR04\">Device Model Info</a>"
