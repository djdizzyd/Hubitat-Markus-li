...
metadata {
    ...
    definition (name: "Tasmota - Universal Dimmer (Child)", namespace: "tasmota", author: "Markus Liljergren", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-dimmer-child-expanded.groovy") {
        capability "Actuator"
...
public getDeviceInfoByName(infoName) { 
    ...
    def deviceInfo = ['name': 'Tasmota - Universal Dimmer (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-dimmer-child-expanded.groovy']
