...
metadata {
	definition (name: "Tasmota - CE Smart Home LQ-2-W3 Wall Outlet", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-ce-lq-2-w3-wall-outlet-expanded.groovy") {
        capability "Actuator"
        capability "Outlet"
		capability "Switch"
...
public getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - CE Smart Home LQ-2-W3 Wall Outlet', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-ce-lq-2-w3-wall-outlet-expanded.groovy']
...
def update_needed_settings()
{
    ...
    if(deviceTemplateInput == null || deviceTemplateInput == "") {
        ...
        useDefaultTemplate = true
        defaultDeviceTemplate = '{"NAME":"CE LQ-2-W3","GPIO":[255,255,255,255,255,17,255,255,21,255,255,255,255],"FLAG":15,"BASE":18}'
    }
