...
metadata {
	definition (name: "Tasmota - CE Smart Home LQ-2-W3 Wall Outlet", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch") {
        capability "Actuator"
		capability "Switch"
		capability "Sensor"
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - CE Smart Home LQ-2-W3 Wall Outlet', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch']
