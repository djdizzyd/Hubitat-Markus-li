...
metadata {
	definition (name: "Tasmota - CE Smart Home LA-2-W3 Wall Outlet", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch") {
        capability "Actuator"
		capability "Switch"
		capability "Sensor"
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - CE Smart Home LA-2-W3 Wall Outlet', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch']
...
def update_needed_settings()
{
    ...
    if(deviceTemplateInput == null || deviceTemplateInput == "") {
        ...
        useDefaultTemplate = true
        defaultDeviceTemplate = '{"NAME":"CE LA-2-W3","GPIO":[255,255,255,255,157,17,0,0,21,255,255,255,255],"FLAG":15,"BASE":18}'
    }
...
private def getDriverVersion() {
	...
	def cmds = []
    comment = "<a target=\"blakadder\" href=\"https://templates.blakadder.com/ce_smart_home_LA-2-W3.html\">Device Model Info</a>"
