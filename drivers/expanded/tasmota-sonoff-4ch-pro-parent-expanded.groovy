...
metadata {
	definition (name: "Tasmota - Sonoff 4CH Pro (Parent)", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch") {
        capability "Actuator"
		capability "Switch"
		capability "Sensor"
...
def getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - Sonoff 4CH Pro (Parent)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch']
