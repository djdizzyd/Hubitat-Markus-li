...
metadata {
	definition (name: "Tasmota - Sonoff 4CH Pro (Parent)", namespace: "tasmota", author: "Markus Liljergren", vid: "generic-switch", importURL: "https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-sonoff-4ch-pro-parent-expanded.groovy") {
        capability "Actuator"
        capability "Light"
		capability "Switch"
		capability "Sensor"
    ...
    preferences {
        ...
        input(name: "numSwitches", type: "enum", title: "<b>Number of Relays</b>", description: "<i>Set the number of buttons/relays on the device (default 4)</i>", options: ["1", "2", "3", "4", "5", "6"], defaultValue: "4", displayDuringSetup: true, required: true)
...
public getDeviceInfoByName(infoName) { 
    ...
    deviceInfo = ['name': 'Tasmota - Sonoff 4CH Pro (Parent)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'vid': 'generic-switch', 'importURL': 'https://raw.githubusercontent.com/markus-li/Hubitat/release/drivers/expanded/tasmota-sonoff-4ch-pro-parent-expanded.groovy']
...
def update_needed_settings()
{
    ...
    if(deviceTemplateInput == null || deviceTemplateInput == "") {
        ...
        useDefaultTemplate = true
        defaultDeviceTemplate = '{"NAME":"Sonoff 4CH Pro","GPIO":[17,255,255,255,23,22,18,19,21,56,20,24,0],"FLAG":0,"BASE":23}'
    }
...
def parse(asyncResponse, data) {
    logging("parse(asyncResponse = \"${asyncResponse.getData()}\", data = \"${data}\")", 1)
}
